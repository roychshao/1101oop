...
private:
	...
	int playerCredit;	// to record the player's credit
	int dealerCredit;	// to record the dealer's credit
	bool init;	// if player haven't restart the game , but choose "more card" or "enough" then print "Game over"
};
