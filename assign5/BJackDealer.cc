...
BJackDealer::BJackDealer(int nSet): BJackPlayer("Dealer") {
	...
	//	take off the variable "dealer" , so the initialization list change to the BJackPlayer's constructor not dealer
...
//	change the function's name so that I can use different start() by call different function name.
void
BJackDealer::start_d(void) {
...
// because of inheritance , this function is no need
/*
void 
...
void 
BJackDealer::addCard_d() {

    addCard(giveCard());

}

// because of inheritance , this function is also no need furthermore
/*
void 
